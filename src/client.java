...
class Client extends SimuUnit
{
    ...
    Client(OTUnit otunit)
    {
        unit=new ClientUnit(otunit);
    ...
    OTUnit getCurrentState()
    {
        return unit.currentNode.otunit;
    }
    void showCurrent()
    {
        System.out.print(unit.currentNode.otunit);
    }
