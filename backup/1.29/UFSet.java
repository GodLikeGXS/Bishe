...
class UFSet implements StateMachine,Cloneable
 {
     /*元素个数 编号为1,2,3...n*/
     int nElements;
     /*所有等价类*/
     ...
     private void Union(int e1,int e2)
     {
         ...
         belongTo[e2]=belongTo[e1].merge(belongTo[e2]);
     }
     ...
     /*
     public static Operation[] transform(UFSet ufSet,Operation op1,Operation op2)
     {
         ...
         if(op1 instanceof UnionOp && op2 instanceof SplitOp)
         {
             ...
             equClass e1=ufSet.belongTo[op1.parameterList.get(0)],e2=ufSet.belongTo[op1.parameterList.get(1)];
     ...
     */
     ...
     public static Operation[] transform(UFSet ufSet,Operation op,Operation[] oplist)
     {
